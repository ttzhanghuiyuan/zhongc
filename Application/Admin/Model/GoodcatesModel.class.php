 ...
 */
class GoodcatesModel extends Model{
    ...
    protected $_auto = array(
       ...
       /* array('sort', '1', self::MODEL_BOTH),
        array('show', '1', self::MODEL_BOTH),*/
        array('application','arr2str',self::MODEL_BOTH,'function' )
    );
    ...
    public function getTree($id = 0, $field = true){
        ...
        $list = $this->join('left join hg_picture picture on picture.id = hg_goodcates.picture_id')->field($field)->where($map)->order('hg_goodcates.sort')->select();
    ...
    public function update(){
        ...
        S('sys_goodcates_list',$this->getTree(0,'hg_goodcates.application,hg_goodcates.id,hg_goodcates.name,hg_goodcates.sort,hg_goodcates.pid,hg_goodcates.show,picture.path'));

        //记录行为
        action_log('update_goodcates', 'goodcates', $data['id'] ? $data['id'] : $res, UID);
