...
function ajax_lists(model,page){
    var target = '/Admin/Nav/lists'; //Think.U('Admin/Nav/lists');
...
function ajax_search(model,key){
    ...
    var target = '/Admin/Nav/ajax_search';//Think.U('Admin/Nav/ajax_search');
...
function ajax_add_menu(nav_name){
    ...
    var target = '/Admin/Nav/ajax_add_menu';//Think.U('Admin/Nav/ajax_add_menu');
...
$(function(){
    ...
    $('.btn_menu_del').click(function(){
        ...
        var target = '/Admin/Nav/ajax_del_menu';//Think.U('Admin/Nav/ajax_del_menu');
    ...
    $('.btn_menu_save').click(function(){
        ...
        var target = '/Admin/Nav/ajax_save_menu';//Think.U('Admin/Nav/ajax_save_menu');
